...
public class MyPantryFragment extends SherlockListFragment
{
   private static final CharSequence[] ADD_METHODS = { "Browse", "Scan Barcode" };
   ...
   public void onCreateOptionsMenu(Menu menu, MenuInflater inflater)
   {
      ...
      inflater.inflate(R.menu.optionsmenu_mypantry, menu);
   }
